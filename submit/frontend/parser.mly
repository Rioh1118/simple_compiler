...
| block              { $1 }
| SEMI               { NilStmt }
| error SEMI         {printf "Error detected, skipping to next statement.\n"; NilStmt}
;
...
aargs :
  aargs COMMA expr   { $1 @ [$3] }
| expr               { [$1] }
;

block :
  LB decs stmts RB   { Block ($2, $3) }
;
